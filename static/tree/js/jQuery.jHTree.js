...
(function ($) {
    ...
    $.widget("jHtree.jHTree", {
        ...
        _createNode: function (node, parentLiNode) {
            ...
            var nodeLiElements = '<li id="' + node.id + '" class="tnode" >' + beforeDiv + '<div class="trcont fk"><div class="ui-widget-header ui-corner-tl ui-corner-tr">' +'<a href="http://127.0.0.1:8000/user_info/'+node.id+'">'+
                node.head +'</a>' + '</div><div class="ui-widget-content ui-corner-bl ui-corner-br">' +
